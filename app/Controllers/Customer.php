...
class Customer extends Controller
{
    ...
    public function delete($id)
    {
        ...
        $orders = $orderModel->where('customer_id', $id)->findAll();
        if (count($orders) > 0) {
            return $this->response->setJSON(['success' => false, 'message' => 'Cannot delete Customer because there are Orders associated with it.']);
        }
